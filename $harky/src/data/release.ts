...
export const RELEASE_NOTES: ReleaseNote[] = [
  {
    version: '1.9.1',
    date: '2026-09-20',
    title: 'Cuentas y Analisis rediseniados, y un arreglo importante de patrimonio',
    items: [
      'nuevo: CUENTAS rediseniada por completo. Tu dinero y tus tarjetas ya no comparten la misma fila: un saldo es un numero, una tarjeta tiene dos saldos, un limite, un ciclo y un interes. Cada uno tiene ahora el espacio que necesita.',
      'nuevo: Arriba de Cuentas aparece tu proximo pago de tarjeta: cuanto y cuando, sin abrir nada.',
      'nuevo: Las tarjetas muestran su red (Visa, Mastercard, Amex...) y si son de debito, ahorro o credito.',
      'nuevo: Selector de banco con mas de 60 entidades dominicanas e internacionales, con buscador. Se elige de la lista: escribirlo a mano hacia que las comisiones automaticas no se aplicaran.',
      'nuevo: Pagar tarjeta desde su propia ficha, con atajos de pagar el minimo o pagar todo. Antes habia que salir a crear una transferencia.',
      'mejor: Conciliar saldo subio al frente de la ficha. Estaba al fondo, despues de toda la actividad.',
      'nuevo: Ahora puedes fijar un cupo propio para la linea en dolares, cuando tu tarjeta lo maneja aparte.',
      'nuevo: ANALISIS rediseniada: ahora abre diciendote como vas, en una frase, con una sola cifra que la sostiene. Antes abria con cuatro numeros empatados y cinco secciones cerradas.',
      'mejor: Los avisos mas importantes salieron a la superficie en vez de vivir dentro de una seccion plegada.',
      'mejor: La vista "Anual" se fusiono con el periodo anual de Analisis, que ya mostraba lo mismo. Lo suyo (mejor mes, mes de mayor gasto, fuentes de ingreso y exportar como imagen) esta ahi.',
      'mejor: El Efectivo es uno solo, como debe ser. Para guardar dinero aparte, crea una cuenta de Ahorro.',
      'nuevo: Onboarding: en vez de explicarte la app, te deja con tus saldos reales cargados.',
      'mejor: Las notificaciones de la app se ordenaron por lo que pide tu atencion. El historial va plegado.',
      'nuevo: Si el banco te avisa de una compra que TU ya registraste, ya no se agrega sola: te avisa que puede estar repetida y decides tu.',
      'arreglo: GRAVE - la deuda en dolares de una tarjeta no contaba en tu patrimonio neto, ni en el total adeudado, ni en los totales por grupo. El numero se veia correcto y no lo era.',
      'arreglo: al editar un movimiento no se podia cambiar su divisa, y cambiarle el monto dejaba la tasa vieja guardada.',
      'arreglo: los gastos en divisa extranjera no contaban bien en el calendario ni en la proyeccion de flujo de caja.',
      'arreglo: las Novedades no aparecian al abrir la app despues de actualizar.',
      'arreglo: un aviso del banco en dolares se registraba como si fueran pesos.',
      'arreglo: los movimientos recurrentes solo se generaban al abrir la app. Ahora tambien al volver a ella.',
      'mejor: la app abre casi 2 segundos mas rapido. Habia una pantalla de carga propia encima de la de Android, con una barra que en realidad no media nada.',
    ],
  },
  {
    version: '1.9.0',
