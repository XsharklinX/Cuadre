  ...
  if (!javaHome) {
    console.error(
      "No se encontró un JDK. Instala Android Studio o un JDK 17+ y define JAVA_HOME, " +
        "o agrega su ruta a FALLBACK_JDK_PATHS en scripts/env.js.",
    );
    process.exit(1);
  }
  ...
  if (!androidHome) {
    console.error(
      "No se encontró el SDK de Android. Instálalo desde Android Studio y define ANDROID_HOME, " +
        "o agrega su ruta a FALLBACK_SDK_PATHS en scripts/env.js.",
    );
    process.exit(1);
  }
...
module.exports = { resolveJavaHome, resolveAndroidHome, resolveBuildEnv };
